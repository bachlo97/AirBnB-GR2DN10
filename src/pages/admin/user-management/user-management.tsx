import { getUsersThunk, openModal, searchUsersThunk } from '@/redux/admin/user-management/user-management.slice'
  ...
  },
  {
      ...
      render: (_,{gender}) =>
        (
          ...
          {gender === 'male' ? <IoIosMale className='text-blue-500' /> : <IoFemaleOutline className='text-pink-500' /> }
          </div>
        )
  },
  {
      ...
      render: (_, { action }) => {
        return (
            <div className='flex gap-4'>
              <div className='self-center text-blue-500 cursor-pointer' onClick={()=> dispatch(openModal())}>
              <VscEdit/>
              </div>
                ...
                >
                    <span
                        className={
                            " mr-3 cursor-pointer text-[20px] text-red-500"
                        }
                        onClick={async () => {}}
                    >
                      <TiDelete/>
