...
export function Item({bgIcon,icon,title,value,rate,unit}: Props) {
  return (
    <div>
      <div className="relative my-[30px] min-h-[150px] flex w-full min-w-0 flex-col break-words rounded-[6px] border-0 bg-white text-[14px] text-[#333] shadow-[0_1px_4px_0_rgba(0,0,0,.14)]">
        <div className="my-5 flex items-center justify-center  gap-10">
          <div className={`flex h-[90px] w-[90px] items-center justify-center   rounded-md ${bgIcon} shadow-xl `}>
